...
To run the program, just run mashupH_main.m. mashupH_main.m is the entrance of the program，set the relevant parameters according to the notes and then run.


mashupH.m: The program used to process data. The input data will be constructed into a matrix to perform operations.
...
data.txt: Network file fed into mashupH_main.m.
